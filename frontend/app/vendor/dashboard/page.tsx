...
import {
  useVendorEarnings,
  useVendorStats,
} from "@/lib/api/vendor-dashboard-queries";
import type { BookingStatus } from "@/lib/api/bookings";
import type { VendorEarnings, VendorStats } from "@/lib/api/vendor-dashboard";
...
function EarningsGrid({ earnings }: { earnings: VendorEarnings }) {
...
function StatsGrid({ stats }: { stats: VendorStats }) {
