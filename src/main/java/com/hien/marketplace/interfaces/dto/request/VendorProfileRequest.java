...
/**
 * Request DTO for creating/updating vendor profile.
 *
 * WHY: Separate from registration because:
 * - User can become vendor later (not only at registration)
 * - Vendor profile has different fields than user profile
 * - Vendor needs business verification
 */
